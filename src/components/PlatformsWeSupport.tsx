    ...
    <section className="section-container">
      <div className="text-center mb-8 md:mb-16">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
          We're experts in managing and optimizing campaigns across all major digital marketing platforms.
        </p>
      </div>

      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
        {platforms.map((platform, index) => (
          <Card key={index} className="border border-resgato-light-purple shadow-md hover:shadow-lg transition-all duration-300">
