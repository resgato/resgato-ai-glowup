      ...
      <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2 lg:gap-12">
        <div>
          ...
          <p className="mb-4 text-base text-gray-700 md:mb-6 md:text-lg">
            ...
            across Salt Lake City and throughout Utah achieve sustainable growth
            and market leadership.
          </p>
          <p className="mb-4 text-base text-gray-700 md:mb-6 md:text-lg">
            Our Utah-based ad agency team specializes in creating and managing
            targeted campaigns that maximize ROI while our content marketing
            experts craft compelling narratives that engage your local Utah
            audience. With our integrated digital marketing solutions, we
            provide end-to-end management of your online presence, ensuring
            consistent brand messaging and optimal performance across all
            channels.
          </p>
        ...
        <div className="grid grid-cols-2 gap-3 md:gap-6">
          <div className="space-y-3 md:space-y-6">
            <div className="rounded-lg bg-resgato-light-purple p-4 md:p-6">
              ...
              <p className="text-sm text-gray-700 md:text-base">
                ...
                strategic planning for Utah businesses.
              </p>
            </div>
            <div className="rounded-lg bg-resgato-light-purple p-4 md:p-6">
              <h3 className="mb-1 text-lg font-semibold md:mb-2 md:text-xl">
              ...
              <p className="text-sm text-gray-700 md:text-base">
                ...
                that consistently deliver exceptional ROI for our Utah clients.
              </p>
            </div>
          </div>
          <div className="mt-3 space-y-3 sm:mt-6 md:mt-12 md:space-y-6">
            ...
            <div className="rounded-lg bg-resgato-light-purple p-4 md:p-6">
              ...
              <p className="text-sm text-gray-700 md:text-base">
                Comprehensive digital marketing management with a focus on local
                SEO optimization for Utah businesses, strategic content
                creation, and data-driven PPC campaigns that maximize your
