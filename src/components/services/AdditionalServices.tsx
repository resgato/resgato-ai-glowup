...
const AdditionalServices = () => {
  const additionalServices = [
    ...
    },
    {
      ...
      description:
        'Monitor and analyze customer sentiment across digital channels.',
      link: '/contact',
    },
    {
      ...
      description:
        'Optimize your website and content for search engines using AI techniques.',
      link: '/contact',
    },
    {
      ...
      description:
        'Deliver tailored experiences to individual customers based on their preferences.',
      link: '/contact',
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {additionalServices.map((service, index) => (
            ...
            >
              <Card className="h-full border-resgato-light-purple shadow-md transition-all duration-300 hover:shadow-lg">
                <CardHeader>
