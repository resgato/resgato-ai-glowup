  ...
  const mainServiceData = [
    {
      ...
      description:
        'Comprehensive marketing strategies designed to drive business growth.',
      details:
    ...
    },
    {
      ...
      description:
        'Forecast market trends and customer behaviors using advanced AI models.',
      details:
    ...
    },
    {
      ...
      description:
        'Implement intelligent conversational agents to engage with customers.',
      details:
    ...
    <section className="section-container">
      <div className="mb-16 text-center">
        ...
        <p className="mx-auto max-w-3xl text-xl text-gray-600">
          Our comprehensive suite of marketing services designed to transform
          your business.
        </p>
      </div>
