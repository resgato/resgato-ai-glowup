...
const CTASection = () => {
  return (
    <section className="bg-gradient-to-r from-resgato-navy to-resgato-blue text-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <Button asChild className="bg-white text-resgato-navy hover:bg-gray-100 px-8 py-6 text-lg">
            <Link to="/contact">
