  ...
  const services = [
    {
      ...
      description:
        'Advanced SEM strategies that capture high-intent automotive shoppers through precision targeting and intelligent bid management.',
      features: [
    ...
    },
    {
      ...
      description:
        'Compelling video content that showcases your inventory and drives engagement across YouTube, social platforms, and connected TV.',
      features: [
    ...
    },
    {
      ...
      description:
        'Strategic social media campaigns that build brand awareness and drive qualified leads through targeted audience engagement.',
      features: [
    ...
    },
    {
      ...
      description:
        'Professional design solutions that elevate your brand and create compelling visual experiences that convert prospects into customers.',
      features: [
        'Email Blast Design',
        'Web Slider Design',
  ...
  const uniqueOpportunities = [
    {
      ...
      description:
        'Our advanced targeting identifies and captures high-intent automotive buyers who are ready to make purchasing decisions.',
    },
    {
      icon: <Award className="h-6 w-6 text-resgato-purple" />,
      title: 'Industry Specialization',
      description:
        'Deep automotive market knowledge combined with cutting-edge marketing expertise delivers unmatched results for dealerships.',
    },
    {
      icon: <Users className="h-6 w-6 text-resgato-purple" />,
      title: 'Dedicated Partnership',
      description:
        "We treat your dealership's success as our own, providing personalized attention and dedicated support throughout our partnership.",
    },
    {
      icon: <Lightbulb className="h-6 w-6 text-resgato-purple" />,
      title: 'Innovative Creative Solutions',
      description:
        'Our creative team develops breakthrough campaigns that maximize your marketing budget and create lasting brand impact.',
    },
    {
      icon: <BarChart3 className="h-6 w-6 text-resgato-purple" />,
      title: 'Analytics-Driven Strategy',
      description:
        'Every marketing decision is backed by comprehensive data analysis and real-time performance insights to optimize your campaigns.',
    },
    {
      icon: <Car className="h-6 w-6 text-resgato-purple" />,
      title: 'Automotive Market Mastery',
      description:
        'Our specialized focus on automotive marketing means you can concentrate on what you do best - selling vehicles while we handle the marketing.',
    },
  ];
  ...
  const portfolioItems = [
    {
      ...
      image:
        '/resgato-uploads/dealershipmarketing/newcardealer_creativedesign.png',
    },
    {
    ...
    },
    {
      ...
      image:
        '/resgato-uploads/dealershipmarketing/motorcycledealer_emailmarketing.png',
    },
    {
      title: 'Used Car Dealer Sales Event',
      category: 'Event Marketing',
      image:
        '/resgato-uploads/dealershipmarketing/usedcardealer_salesevent.png',
    },
    {
      title: 'New Car Dealer Multi-Channel',
      category: 'Multi-Channel',
      image:
        '/resgato-uploads/dealershipmarketing/newcardealer_multichannel.png',
    },
    {
      title: 'Motorcycle Dealer Content Creation',
      category: 'Content Marketing',
      image:
        '/resgato-uploads/dealershipmarketing/motorcycledealers_contentcreation.png',
    },
    {
      title: 'Used Car Service Marketing',
      category: 'Service Marketing',
      image:
        '/resgato-uploads/dealershipmarketing/usedcar_servicemarketing.png',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="flex-grow">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
            <div className="mx-auto max-w-4xl text-center text-white">
              ...
              <p className="mt-6 text-xl text-white/90">
                Resgato delivers cutting-edge marketing solutions specifically
                designed for automotive dealerships. Our data-driven approach
                combines advanced digital strategies with deep industry
                expertise to accelerate your sales and maximize ROI.
              </p>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center">
              <h2 className="text-3xl font-bold text-resgato-navy">
                Why Choose Resgato
              </h2>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-resgato-navy">
                  Industry Expertise
                </h3>
                <p className="mt-2 text-gray-600">
                  Specialized knowledge of automotive sales cycles and customer
                  journey mapping
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="mt-2 text-gray-600">
                  Seamless campaigns across all touchpoints to maximize customer
                  engagement
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="mt-2 text-gray-600">
                  Custom strategies that deliver measurable growth and increased
                  profitability
                </p>
              </div>
            </div>
                ...
                <Card key={index} className="h-full">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      {service.icon}
                      <CardTitle className="text-xl text-resgato-navy">
                        {service.title}
                      </CardTitle>
                    </div>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center">
              ...
              <p className="mt-4 text-lg text-gray-600">
                What makes Resgato the preferred choice for automotive
                dealerships
              </p>
            </div>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {uniqueOpportunities.map((opportunity, index) => (
                <div key={index} className="text-center">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-resgato-navy">
                    {opportunity.title}
                  </h3>
              ...
              {portfolioItems.map((item, index) => (
                ...
                >
                  <CardContent className="p-6">
                    ...
                    <h3 className="mb-1 font-semibold text-resgato-navy">
                      {item.title}
                    </h3>
        ...
        {/* CTA Section */}
        <section className="bg-resgato-purple py-16">
          <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            <h2 className="mb-4 text-3xl font-bold text-white">
              Ready to Accelerate Your Sales?
            </h2>
            <p className="mx-auto mb-8 max-w-3xl text-xl text-white/90">
              Partner with Resgato to transform your dealership's marketing
              performance. Our proven automotive marketing strategies deliver
              measurable results that drive more sales, higher quality leads,
              and maximum return on your marketing investment.
            </p>
