  ...
  const contentStrategyFeatures = [
    {
      ...
      description:
        'Strategic planning of your content schedule to maintain consistency and maximize impact across all channels.',
    },
    {
      icon: <FileText className="h-6 w-6 text-resgato-purple" />,
      title: 'Content Creation',
      description:
        'Professional creation of engaging blog posts, articles, whitepapers, and other content formats tailored to your audience.',
    },
    {
      icon: <PenTool className="h-6 w-6 text-resgato-purple" />,
      title: 'Content Optimization',
      description:
        'Enhancement of existing content to improve SEO performance, readability, and conversion rates.',
    },
    {
      icon: <BarChart className="h-6 w-6 text-resgato-purple" />,
      title: 'Performance Analysis',
      description:
        'Detailed analysis of content performance metrics to continuously refine your content strategy.',
    },
  ];
