  ...
  const websiteDevelopmentFeatures = [
    {
      ...
      description: "Tailored website solutions built with modern technologies to meet your specific business needs and goals."
    },
    {
      icon: <Smartphone className="h-6 w-6 text-resgato-purple" />,
      title: "Responsive Design",
      description: "Mobile-first design approach ensuring your website looks and functions perfectly across all devices and screen sizes."
    },
    {
      icon: <Globe className="h-6 w-6 text-resgato-purple" />,
      title: "E-commerce Solutions",
      description: "Complete online store development with secure payment processing, inventory management, and customer experience optimization."
    },
    {
      icon: <Zap className="h-6 w-6 text-resgato-purple" />,
      title: "Performance Optimization",
      description: "Lightning-fast loading speeds and optimized performance to improve user experience and search engine rankings."
    },
    {
      icon: <Shield className="h-6 w-6 text-resgato-purple" />,
      title: "Security & Maintenance",
      description: "Ongoing security updates, backups, and maintenance to keep your website secure and running smoothly."
    },
    {
