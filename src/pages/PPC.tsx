  ...
  return (
    <HelmetProvider>
      <div className="min-h-screen flex flex-col">
        <Helmet>
          <title>Utah PPC Agency | Google Ads & PPC Marketing Services | Resgato</title>
          <meta name="description" content="Maximize your ROI with Resgato's expert PPC management services in Utah. Our Salt Lake City PPC consultants deliver results-driven Google Ads campaigns." />
          <meta name="keywords" content="utah ppc agency, ppc marketing utah, salt lake city ppc agency, google ads experts utah, ppc management salt lake city, paid search utah, ppc strategy utah" />
          <link rel="canonical" href="https://resgato.com/ppc" />
          <script type="application/ld+json">{`
            {
              "@context": "https://schema.org",
              "@type": "Service",
              "name": "Utah PPC & Google Ads Management Services",
              "provider": {
                "@type": "LocalBusiness",
              ...
              "description": "Expert PPC campaign management for Utah businesses with focus on maximizing ROI and conversions.",
              "areaServed": {
                "@type": "State",
                "name": "Utah"
              },
          ...
          <script type="application/ld+json">{`
            {
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "What PPC services do you offer in Utah?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Our Utah PPC services include Google Ads management, Microsoft Advertising, landing page optimization, conversion tracking & optimization, remarketing campaigns, and comprehensive PPC strategy development specifically tailored for local Utah businesses."
                  }
                },
                {
                  "@type": "Question",
                  "name": "How much does PPC management cost in Utah?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Our PPC management services for Utah businesses typically range from $1,000-$5,000 monthly depending on campaign scale and ad spend. We structure our fees to ensure you receive maximum value and ROI from your PPC investment."
                  }
                },
                {
                  "@type": "Question",
                  "name": "How long does it take to see results from PPC in Utah?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "While initial results can be seen almost immediately, optimal performance for Utah PPC campaigns typically takes 2-3 months as we refine targeting, messaging, and bidding strategies based on data collected from your specific market and audience."
                  }
                }
              ]
            }
