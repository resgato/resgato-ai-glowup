...
const GeneralizedBrandTransformationCaseStudy = () => {
  const services = [
    {
      icon: <Palette className="h-8 w-8 text-resgato-purple" />,
      title: 'Brand Revitalization',
      description:
        'Complete brand transformation to appeal to new demographics while maintaining trust with existing customers.',
    },
    {
      icon: <Users className="h-8 w-8 text-resgato-purple" />,
      title: 'Audience Targeting',
      description:
        'Strategic targeting to reach new customer segments and expand market reach beyond traditional demographics.',
    },
    {
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              ...
              <div className="relative">
                <div className="overflow-hidden rounded-lg bg-white p-8 shadow-2xl">
                  <div className="text-center text-resgato-navy">
                    <h3 className="mb-4 text-2xl font-bold">Key Results</h3>
                    <div className="space-y-3 text-left">
                      <div className="flex items-center">
                        <CheckCircle className="mr-3 h-5 w-5 text-resgato-purple" />
                ...
                <div className="rounded-lg bg-gray-50 p-6">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Appeal to new customer demographics</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="mr-2 mt-0.5 h-5 w-5 flex-shrink-0 text-resgato-purple" />
...
export default GeneralizedBrandTransformationCaseStudy;
