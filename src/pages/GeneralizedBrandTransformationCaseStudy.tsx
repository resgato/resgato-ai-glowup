  ...
  const services = [
    {
      ...
      description: "Complete brand transformation to appeal to new demographics while maintaining trust with existing customers."
    },
    {
      icon: <Users className="h-8 w-8 text-resgato-purple" />,
      title: "Audience Targeting",
      description: "Strategic targeting to reach new customer segments and expand market reach beyond traditional demographics."
    },
    {
