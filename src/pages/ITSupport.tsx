  ...
  const itSupportFeatures = [
    {
      ...
      description:
        'Reliable, fast, and secure website hosting solutions with 99.9% uptime guarantee, daily backups, and 24/7 monitoring for your Utah business.',
    },
    {
      icon: <Wrench className="h-6 w-6 text-resgato-purple" />,
      title: 'Domain Management',
      description:
        'Complete domain registration, renewal, and management services to ensure your online presence remains secure and accessible.',
    },
    {
      icon: <Settings className="h-6 w-6 text-resgato-purple" />,
      title: 'Managed Services',
      description:
        'Comprehensive managed IT services including server management, security updates, performance optimization, and technical support.',
    },
  ];
