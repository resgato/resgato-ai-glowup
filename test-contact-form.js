  ...
  try {
    ...
    const { data: submissionData, error: submissionError } = await supabase
      ...
      .insert([{
        ...
        phone: '123-456-7890',
        message: 'This is a test message to verify the email trigger is working properly.',
    ...
    console.log('');
    console.log('📧 Check your email at help@resgato.com for the test notification.');
